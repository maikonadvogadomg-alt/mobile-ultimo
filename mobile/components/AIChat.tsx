...
async function callAI(
  ...
  // ── Cortesia Gemini — proxy SSE customizado ──────────────────────────────
  if (provider.type === "cortesia") {
    ...
    // No web (React Native Web no browser), o ReadableStream às vezes não funciona;
    // usamos response.text() como fallback confiável.
...
8. PLANO DE EXECUÇÃO: Para tarefas grandes, liste os passos numerados e peça confirmação para começar. Depois execute passo a passo dando feedback de cada um.`;
  ...
  return (
    ...
    >
      ...
      {/* Chips de resposta rápida (aparecem após a IA responder) */}
      ...
      {/* Atalhos de geração (modo Dev + projeto ativo) */}
      ...
      <View style={[styles.inputRow, { backgroundColor: colors.card, borderTopColor: colors.border }]}>
        ...
        <TextInput
          ...
          placeholder="Pergunte, peça ajuda, diga OK..."
          placeholderTextColor={colors.mutedForeground}
          multiline
          maxLength={4000}
